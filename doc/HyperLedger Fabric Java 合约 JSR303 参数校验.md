...
@Contract(
        ...
        transactionSerializer = "org.wang.ValidationJSONTransactionSerializer" ,
        info = @Info(
                title = "User contract",
...
Thread[fabric-txinvoke:2,5,main] 08:57:59:033 INFO    org.hyperledger.fabric.contract.ContractRouter processRequest                    Got routing:regUser:org.wang.UserContract
Thread[fabric-txinvoke:2,5,main] 08:57:59:042 INFO    org.wang.ValidationJSONTransactionSerializer fromBuffer                        对请求参数执行参数校验 {"birthday":"1980-01-27","idCard":"610102198910210321","key":"","name":"\u54C8\u54C8\u54C8\u54C8lx","phone":"18729977979","sex":"\u7537"}
Thread[fabric-txinvoke:2,5,main] 08:57:59:107 INFO    org.wang.ValidationJSONTransactionSerializer fromBuffer                        参数校验不通过,错误信息 {"key":"key 不能为空"}
Thread[fabric-txinvoke:2,5,main] 08:57:59:108 SEVERE  org.hyperledger.fabric.Logger error                                              参数校验不通过,错误信息 {"key":"key 不能为空"}org.hyperledger.fabric.shim.ChaincodeException: 参数校验不通过,错误信息 {"key":"key 不能为空"}
	at org.wang.ValidationJSONTransactionSerializer.fromBuffer(ValidationJSONTransactionSerializer.java:49)
